...
- skills
- C:\Users\dj_no\.config\opencode\skills
- C:\Users\dj_no\.claude\skills
- C:\Users\dj_no\.gemini\skills
- C:\Users\dj_no\.gemini\antigravity\skills
- C:\Users\dj_no\.cursor\skills
- C:\Users\dj_no\.copilot\skills
- C:\Users\dj_no\.codex\skills
...
### brainstorm
- Path: C:\Users\dj_no\.config\opencode\skills\brainstorm\SKILL.md
- Trigger: >
- Rules:
...
### branch-pr
- Path: C:\Users\dj_no\.config\opencode\skills\branch-pr\SKILL.md
...
### chained-pr
- Path: C:\Users\dj_no\.config\opencode\skills\chained-pr\SKILL.md
...
- Path: C:\Users\dj_no\.config\opencode\skills\cognitive-doc-design\SKILL.md
...
### comment-writer
- Path: C:\Users\dj_no\.config\opencode\skills\comment-writer\SKILL.md
...
### debug
- Path: C:\Users\dj_no\.config\opencode\skills\debug\SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### engram-conventions
- Path: C:\Users\dj_no\.config\opencode\skills\engram-conventions\SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### go-testing
- Path: C:\Users\dj_no\.config\opencode\skills\go-testing\SKILL.md
...
### imagegen
- Path: C:\Users\dj_no\.codex\skills\.system\imagegen\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### issue-creation
- Path: C:\Users\dj_no\.config\opencode\skills\issue-creation\SKILL.md
...
### judgment-day
- Path: C:\Users\dj_no\.config\opencode\skills\judgment-day\SKILL.md
...
### openai-docs
- Path: C:\Users\dj_no\.codex\skills\.system\openai-docs\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### opencode-model-routing
- Path: C:\Users\dj_no\.config\opencode\skills\opencode-model-routing\SKILL.md
- Trigger: >
- Rules:
  - **You cannot choose the LLM dynamically per task from prompts alone.**
  - defining/using different agents, and
  - assigning each agent a different `model`.
  - **Decide models by work type (not by file type).**
  - **Always verify available models in the user config before recommending changes.**
  - **Ask before editing config.**

### plugin-creator
- Path: C:\Users\dj_no\.codex\skills\.system\plugin-creator\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### skill-creator
- Path: C:\Users\dj_no\.config\opencode\skills\skill-creator\SKILL.md
...
### skill-installer
- Path: C:\Users\dj_no\.codex\skills\.system\skill-installer\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### work-unit-commits
- Path: C:\Users\dj_no\.config\opencode\skills\work-unit-commits\SKILL.md
