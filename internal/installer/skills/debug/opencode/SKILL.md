...
> ⚠️ **MANDATORY — NO FIXES WITHOUT ROOT CAUSE INVESTIGATION FIRST**
...
1. **Create a failing test** — simplest reproduction possible. Automated
   ...
   fixing. (If a test-driven-development skill is available in your
   environment, use it.)
...
skill to be installed. If `engram-conventions` is installed, defer to it
for fuller guidance.
...
- **OpenCode**: `~/.config/opencode/skills/debug/SKILL.md`
- **Claude Code**: `~/.claude/skills/debug/SKILL.md` (use the Claude
