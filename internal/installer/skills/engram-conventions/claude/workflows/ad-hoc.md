...
When the content is substantial and the user wants to validate the reasoning
before moving on, emit the review URL after saving:
...
When the content represents a significant system-wide decision and the user
wants to review the architectural rationale before proceeding, emit the review
URL:
