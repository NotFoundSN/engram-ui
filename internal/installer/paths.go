...
// ClaudeSkillDir returns the destination root for the engram-conventions skill
// under Claude Code: {home}/.claude/skills/engram-conventions
func ClaudeSkillDir(homeDir string) string {
	return filepath.Join(homeDir, ".claude", "skills", "engram-conventions")
}

// OpenCodeSkillDir returns: {base}/opencode/skills/engram-conventions
...
func OpenCodeSkillDir(homeDir, xdgConfigHome string) string {
	base := xdgConfigHome
	if base == "" {
		base = filepath.Join(homeDir, ".config")
	}
	return filepath.Join(base, "opencode", "skills", "engram-conventions")
}
